...
- **Impact:** Two 7-figure deals — the Coles deal (~$1.2M) and the Qantas deal (~$1.4M) — each slipped a full quarter after being carried to the board as commit, and Priya (CRO) "lost the room" with the board over the miss. Board-level forecast credibility — not tooling cost — was the thing on the line. Priya framed forecast confidence ahead of June planning as worth materially more than the platform price.
...
## Call history
- 2026-02-10 — discovery — [link](../calls/2026-02-10_culture-amp-forecast-platform-discovery.md) — Discovery with Sofia (Sales Ops). They run Clearwater for dashboards b…
- 2026-02-24 — demo — [link](../calls/2026-02-24_culture-amp-forecast-platform-demo.md) — Demo to Priya (CRO). Two slipped 7-figure deals were the emotional hoo…
- 2026-03-18 — technical — [link](../calls/2026-03-18_culture-amp-forecast-platform-technical.md) — Security + integration deep-dive with Ken. SOC2, data residency, SSO a…
- 2026-05-12 — negotiation — [link](../calls/2026-05-12_culture-amp-forecast-platform-negotiation.md) — Negotiation with Priya. Closed a 2-year deal before June planning.…
